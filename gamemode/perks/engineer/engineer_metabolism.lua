...
PERK.Hooks.PostEntityTakeDamage = function (ent, dmg, took)
    ...
    if took and ent:IsNPCHorde() and attacker:IsPlayer() and (inflictor:GetNWEntity("HordeOwner"):IsPlayer() or (ent.Horde_Has_Parasite and ent.Horde_Has_Parasite:IsPlayer())) and attacker:Horde_GetPerk("engineer_metabolism") then
